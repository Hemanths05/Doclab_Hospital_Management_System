    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings">
                        <a href="his_doc_add_pharm_cat.php" class="non-style-link-menu"><div><p class="menu-text">Pharmacy</p></a></div>
                        <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_doc_add_pharm_cat.php" class="non-style-link-menu" >Add Pharm Category</a>
                                    </li>
                                    <li>
                                        <a href="his_doc_view_pharm_cat.php"  class="non-style-link-menu">View Pharm Category</a>
                                    </li>
                    </td>
                </tr>
