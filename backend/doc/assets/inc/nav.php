    ...
    <div class="navbar-custom">
        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    <img src="assets/images/logo-light1.png" alt=""  height="100"; width="100" style="margin-top: -15px"; >
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-sm">
                    <!-- <span class="logo-sm-text-dark">U</span> -->
                    <img src="assets/images/logo-sm1.png"  height="100"; width="100" style="margin-top: -15px"; alt="">
                </span>
            </a>
        </div>
