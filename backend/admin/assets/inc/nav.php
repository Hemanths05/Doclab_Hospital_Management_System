    ...
    <div class="navbar-custom">
        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    <img src="assets/images/logo-light1.png"  height="100"; width="100" style="margin-top: -15px"; alt="" height="18">
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-sm">
                    <!-- <span class="logo-sm-text-dark">U</span> -->
                    <img src="assets/images/logo-sm-white.png" height="100"; width="100"  style="margin-top: -15px"; alt="" height="24">
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            <li>
                <button class="button-menu-mobile waves-effect waves-light">X-UA-Compatible
                    <i class="fe-menu"></i>
                </button>
            </li>
